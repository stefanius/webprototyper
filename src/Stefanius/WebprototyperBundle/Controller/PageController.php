...
use Stefanius\WebprototyperBundle\Entity\Page;
use Stefanius\WebprototyperBundle\Form\PageType;
...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('StefaniusWebprototyperBundle:Page')->findAll();
     ...
     * @Method("POST")
     * @Template("StefaniusWebprototyperBundle:Page:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('StefaniusWebprototyperBundle:Page')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("StefaniusWebprototyperBundle:Page:edit.html.twig")
     */
